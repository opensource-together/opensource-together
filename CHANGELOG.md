...
## [0.1.3](https://github.com/opensource-together/opensource-together/compare/v0.1.2...v0.1.3) (2025-06-21)


### Features

* add additional user profile fields in Prisma schema ([78bc4ed](https://github.com/opensource-together/opensource-together/commit/78bc4edc0883b1793dc70e55c8aaedcd3d8c8704))
...
* add ci workflow ([8b01130](https://github.com/opensource-together/opensource-together/commit/8b01130db42e4d5e6130201a3031325854c7d629))
* add ci workflow ([01d8912](https://github.com/opensource-together/opensource-together/commit/01d8912514631caf94c3f5ab228100ec95b9b99b))
...
* add encryption key to environment configuration ([ebdf31e](https://github.com/opensource-together/opensource-together/commit/ebdf31e726a920bd4d8b4fd2a980d0343129a53e))
* add endpoint to retrieve current user profile and update Swagger documentation ([f2f73c0](https://github.com/opensource-together/opensource-together/commit/f2f73c09b1e0225d54cd454a9f54bf0a78deb5c4))
...
* add project management and prepare tech stack features ([1701ae7](https://github.com/opensource-together/opensource-together/commit/1701ae7fc64192747dd1c037fd3557d647cbb2a3))
* add project validation schemas for API and form handling ([e92aa87](https://github.com/opensource-together/opensource-together/commit/e92aa87f8a9bf013462801b28f72ac5a9c5dd16e))
...
* add skeleton loaders for improved loading experience ([018e259](https://github.com/opensource-together/opensource-together/commit/018e2591e570387fae474e89784179c8410a04f1))
...
* add useToastMutation hook for enhanced user feedback ([61e39b8](https://github.com/opensource-together/opensource-together/commit/61e39b8244a4b2bcb72eb3ba682b24d42322c9aa))
* ajout d'index pour améliorer les performances de recherche dans les modèles Project et ProjectRole ([a0e4cf1](https://github.com/opensource-together/opensource-together/commit/a0e4cf1060d797675f534513546d8401a5055c76))
* ajout d'un gestionnaire de requêtes pour le filtrage des projets ([199d3ba](https://github.com/opensource-together/opensource-together/commit/199d3ba2ba6aa656ed59d89be8ee5a6c8ed94eab))
* ajout d'un nouveau DTO pour le filtrage des projets et mise à jour de l'interface du dépôt ([4af7bf3](https://github.com/opensource-together/opensource-together/commit/4af7bf396d790a7e275263a0599708f2213dc34c))
...
* ajout de la dépendance class-transformer ([df40683](https://github.com/opensource-together/opensource-together/commit/df406836d2e66e5c675c5ff78d8703c19eeacd9a))
...
* ajout de la validation globale et mise à jour des modèles de données ([d4dcf42](https://github.com/opensource-together/opensource-together/commit/d4dcf42693cdefdda2d1a1258f2a5bcdcc5e1708))
* ajout des membres de projet et mise à jour des modèles de données ([2e0b8b1](https://github.com/opensource-together/opensource-together/commit/2e0b8b171541e4973b1b7c8ed7dd27462e275658))
...
* amélioration de la documentation Swagger pour le filtrage des projets ([205ed85](https://github.com/opensource-together/opensource-together/commit/205ed85ccb69f5da6c1b37fd86e5748cce158cb4))
...
* enhance user creation command and repository with additional fields ([803cd4c](https://github.com/opensource-together/opensource-together/commit/803cd4c6d000e8f8282b0456bab7cb2cdcbb2b50))
...
* implement authentication middleware and route protection ([b406074](https://github.com/opensource-together/opensource-together/commit/b406074c078de6742edf16e2a7dcef222ac3a14a))
...
* implement encryption service with interface and wiring module ([5dc9a20](https://github.com/opensource-together/opensource-together/commit/5dc9a20c8e2b9af2403ad41ef0ae4f6edbfbf066))
...
* implement GitHub repository creation command and service integration to test github api ([330b3c7](https://github.com/opensource-together/opensource-together/commit/330b3c74ad5e851de17c326a04c16385e28e6996))
* implement new profile page layout and UI based on Figma ([4969715](https://github.com/opensource-together/opensource-together/commit/49697156abbccb7b0b31558628de32dfdc51ca82))
* implement profile management with CRUD operations and user integration ([7d22c35](https://github.com/opensource-together/opensource-together/commit/7d22c35bde2bd0d9ff6033f44d026bb6d45499be))
...
* implement techstack module with repository and query handling ([ee58815](https://github.com/opensource-together/opensource-together/commit/ee58815c9a84fa634caae36455024961d5013412))
...
* implement user update command with encryption for GitHub access token ([a6f7659](https://github.com/opensource-together/opensource-together/commit/a6f7659785eee1dfe2d0c36cecf783a96f0703fe))
* implement UserGitHubCredentials management for user authentication ([b5bcb8e](https://github.com/opensource-together/opensource-together/commit/b5bcb8e26ba826f07e928e1989ef9f6c0342f28a))
* implement UserResponseDto and UserMapper for user data transformation ([0327735](https://github.com/opensource-together/opensource-together/commit/03277352f07cc42820363ab19ae36b5a856a867f))
* improve pinned projects display and layout ([84ecec8](https://github.com/opensource-together/opensource-together/commit/84ecec8350336b1ba4af49a353f820c06c807a83))
...
* mise à jour de la documentation de l'API OpenSource Together ([9c42583](https://github.com/opensource-together/opensource-together/commit/9c42583af4ae588db13cc23886423f1734c2fc1a))
* mise à jour de la documentation Swagger pour inclure des membres de projet ([8c488ef](https://github.com/opensource-together/opensource-together/commit/8c488efdf3f3c67f9382e73b7cfaaf1b4840cb97))
* mise à jour des modèles de données et des mappers pour les rôles de projet et les membres d'équipe ([636fb80](https://github.com/opensource-together/opensource-together/commit/636fb807f12b71599cdad09a4b2d800a3c7bd9b6))
...
* mise à jour du contrôleur de projet pour le filtrage avancé ([e4672d7](https://github.com/opensource-together/opensource-together/commit/e4672d7da7b374fe5335cdf5e679d84cc7997df7))
* mise à jour du dépôt Prisma pour le filtrage des projets ([77e96a8](https://github.com/opensource-together/opensource-together/commit/77e96a830cbdc98bce256b4fcd4be08125259eba))
* mise à jour du DTO de réponse de projet et des requêtes pour le filtrage ([e2a0e42](https://github.com/opensource-together/opensource-together/commit/e2a0e420c605118da433a30ed5888054d5a15713))
* mise à jour du DTO de réponse de projet pour simplifier les données des techStacks ([4d49318](https://github.com/opensource-together/opensource-together/commit/4d49318f7c15e0bc3714e2cb74e9ab3db4c49c39))
* **project-detail:** ajout de la description du projet et déplacement des éléments dans la sidebar ([26edd02](https://github.com/opensource-together/opensource-together/commit/26edd024ea7b6527ecafa1a14c6b347d6b5a8b96))
* **project-detail:** ajout des images dans la page + mise à jour du mock avec les visuels ([897d485](https://github.com/opensource-together/opensource-together/commit/897d485ecc984d94e777e6e771890e82da14598d))
* **project-detail:** ajout et intégration de la nouvelle sidebar ([7b06d80](https://github.com/opensource-together/opensource-together/commit/7b06d80681bf4839927a45ec9ede294b9fbb55a2))
...
* redesign des open roles avec nouveau layout et style ([b27b784](https://github.com/opensource-together/opensource-together/commit/b27b784f10fe92bc08296fa3fd701652637268dc))
...
* add missing env to docker compose ([9de03d3](https://github.com/opensource-together/opensource-together/commit/9de03d3c09dfc46737116aef66c552d1af537fb1))
* add missing env to docker compose ([f9e7364](https://github.com/opensource-together/opensource-together/commit/f9e7364273feda9960b5026010c07450a6e65399))
...
* **auth:** Suppress spurious SuperTokens 401 error on GitHub sign-in ([15b3cf8](https://github.com/opensource-together/opensource-together/commit/15b3cf83ea1becc2d0482cf41cffd3c57f3fb070))
* broken nestjs dependency blocking build in prod ([3d4933e](https://github.com/opensource-together/opensource-together/commit/3d4933e49f3731bca9e89303770b11e1a6de523f))
* broken nestjs dependency blocking build in prod ([0ef37b9](https://github.com/opensource-together/opensource-together/commit/0ef37b944b420ce6677f1b522905b88705d61b47))
* broken swagger doc ([5bcc4a3](https://github.com/opensource-together/opensource-together/commit/5bcc4a3919ec29ad35dec96342915de027d881fe))
* broken swagger doc ([ada7b38](https://github.com/opensource-together/opensource-together/commit/ada7b38de400c60b4424f13aed30eee01fd63ff5))
...
* front github signin button ([3629c50](https://github.com/opensource-together/opensource-together/commit/3629c50d4b0b697ca8da05743b8c3fd52f655dc3))
...
* improve formatting in Swagger documentation and handle bootstrap errors ([190f2c9](https://github.com/opensource-together/opensource-together/commit/190f2c90138e6bfc02a99f89ac187a8257bbd683))
...
* rename update command for GitHub access token management ([c30c78e](https://github.com/opensource-together/opensource-together/commit/c30c78ea917376b5221dbfdd1dfd645b6d7f8de5))
...
* update redirection logic and refactor user store for profile management ([0c484ef](https://github.com/opensource-together/opensource-together/commit/0c484ef6f762b178e99f56156e6fb13f9cf4e2f3))
...
* yamljs import issues ([463bd19](https://github.com/opensource-together/opensource-together/commit/463bd195f9f8a0515492ab34063682997ae87208))
* yamljs import issues ([efae251](https://github.com/opensource-together/opensource-together/commit/efae2512f71ddd54c6737527e0dd46818736bce0))
...
* add missing type ([8faaaaa](https://github.com/opensource-together/opensource-together/commit/8faaaaacf3089e999a4f7abfc6fe208555c5114f))
...
* change linting command ([de79a0c](https://github.com/opensource-together/opensource-together/commit/de79a0c8f8ac694fec55743440cc4e6d0fb2e69f))
...
* create dto to prevent using any ([02aa8c2](https://github.com/opensource-together/opensource-together/commit/02aa8c2be7631eaa6fbaf040ea70eec05f9abf9f))
* created dummy test for obsolete tests ([2356349](https://github.com/opensource-together/opensource-together/commit/2356349f4367fcc5260172aa3b02d63d7529efbc))
...
* fix error handling for linting ([60814da](https://github.com/opensource-together/opensource-together/commit/60814dabf7914ed34d14f07f9bde4924e2688eec))
* fix imports and async return ([79c0aba](https://github.com/opensource-together/opensource-together/commit/79c0aba1592ffc2899e903c81565506b92632428))
* fix untyped constructor ([9aeddfb](https://github.com/opensource-together/opensource-together/commit/9aeddfb9bdd98b2d23ecd9d3fdba77907e0cfb43))
* latest updates for commits ([d8d1563](https://github.com/opensource-together/opensource-together/commit/d8d1563e02ad5890c4316c5778b6a1cbb61f1aa0))
* linter quick fix ([e18658c](https://github.com/opensource-together/opensource-together/commit/e18658c04da9d4b9815b64ef5a0775181ad14366))
...
* refactored error to avoid any type ([c6b3bcd](https://github.com/opensource-together/opensource-together/commit/c6b3bcd1258e5264074b630b104fc4bca6100f51))
* remove obsolete tests ([bcca2a9](https://github.com/opensource-together/opensource-together/commit/bcca2a933d7ed7c10ff537092da8b08ecea790f6))
...
* remove unreachable code ([dd7797d](https://github.com/opensource-together/opensource-together/commit/dd7797d6c40f064a192778f84805326322456f16))
* remove unused imports ([570c520](https://github.com/opensource-together/opensource-together/commit/570c520c7537580b67407088dfd8f5b63332d1be))
...
* remove unused statements ([d001326](https://github.com/opensource-together/opensource-together/commit/d00132685dd04962c95c97915d894acbb6aeff4f))
...
* update Prisma commands in package.json for local development ([ce4a87f](https://github.com/opensource-together/opensource-together/commit/ce4a87f38e31c168a536ef116d3907d317823225))
* update project mock and types for new profile page ([fd1d365](https://github.com/opensource-together/opensource-together/commit/fd1d365b2f5308618dec77350a1b095db28b250e))
...
* ajout d'un commentaire de test dans la documentation Swagger ([79e0125](https://github.com/opensource-together/opensource-together/commit/79e0125d6e0935d5e1c501f37bfe5be08b8ce158))
* ajout d'un commentaire de test dans la documentation Swagger ([3f147d6](https://github.com/opensource-together/opensource-together/commit/3f147d6ab56989c5ec600c815ee0dc9c8f8e8c39))
* ajout d’un README pour documenter le projet ([c5afde7](https://github.com/opensource-together/opensource-together/commit/c5afde7a5b59dcd7a2cbfe91ef355d12bdc3f4f1))
