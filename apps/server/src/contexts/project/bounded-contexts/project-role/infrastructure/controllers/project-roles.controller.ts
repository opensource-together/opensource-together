...
export class ProjectRolesController {
  ...
  @ApiOperation({
    summary:
      'Ajouter un rôle à un projet existant (DEPRECATED - use POST /projects/me/:projectId/roles instead)',
    deprecated: true,
  })
  @ApiCookieAuth('sAccessToken')
  @ApiParam({
  ...
  @ApiOperation({
    summary:
      'Mettre à jour un rôle de projet existant (DEPRECATED - use PATCH /projects/me/:projectId/roles/:roleId instead)',
    deprecated: true,
  })
  @ApiCookieAuth('sAccessToken')
  @ApiParam({
  ...
  @ApiOperation({
    summary:
      'Supprimer un rôle de projet existant (DEPRECATED - use DELETE /projects/me/:projectId/roles/:roleId instead)',
    deprecated: true,
  })
  @ApiCookieAuth('sAccessToken')
  @ApiParam({
