...
const mockProjects: Project[] = [
  {
    ...
    description: "A collaborative platform for open source enthusiasts to discover and contribute to exciting projects",
    longDescription: "Awesome Open Source is a platform designed to connect developers with open source projects. Our mission is to make open source contribution more accessible and enjoyable for everyone, from beginners to experienced developers. We believe in the power of collaboration and community-driven development.",
    status: "PUBLISHED",
    techStacks: [
    ...
    roles: [
      {
        ...
        description: "We're hiring a Backend Developer to build robust, scalable server-side systems and APIs. You'll collaborate with cross-functional teams to deliver reliable backend systems using technologies like Node.js, MongoDB, and Express.",
        badges: [
  ...
  },
  {
    ...
    slug: "eco-tracker",
    title: "Eco Tracker",
    description: "An app that helps users track and reduce their carbon footprint through daily lifestyle choices",
    longDescription: "Eco Tracker is an innovative solution designed to help individuals and organizations monitor and reduce their environmental impact. Through intuitive interfaces and data-driven insights, we empower users to make more sustainable choices in their daily lives.",
    status: "PUBLISHED",
    techStacks: [
    ...
    roles: [
      {
        ...
        description: "We're seeking a Mobile Developer experienced with React Native to help build our cross-platform app. You'll work on creating smooth, responsive interfaces and integrating with backend services.",
        badges: [
      ...
      },
      {
        ...
        description: "We're looking for a Data Scientist to help analyze environmental impact data and create algorithms for personalized sustainability recommendations.",
        badges: [
          { label: "Python", color: "#4B8BBE", bgColor: "#F0F8FF" }
        ]
      }
    ],
    socialLinks: [
