      ...
      contributors: [
        {
          ...
          html_url: "http://localhost:4000/v1/user/user-byron",
          user_id: "user-byron",
          contributions: 3,
        },
        {
          ...
          html_url: "http://localhost:4000/v1/user/user-killian",
          user_id: "user-killian",
          contributions: 2,
        },
        {
          login: "P2aco Dev",
          avatar_url: "/icons/p2aco-icon.png",
          html_url: "http://localhost:4000/v1/user/user-p2aco",
          user_id: "user-p2aco",
          contributions: 1,
        },
      ],
