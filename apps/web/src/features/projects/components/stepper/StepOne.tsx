...
export default function StepOne({ onNext }: { onNext: (mode: "import" | "scratch") => void }) {
  ...
  return (
    <div className="flex flex-col items-center bg-white p-10 rounded-[20px]">
      <h2 className="text-[30px] font-medium tracking-tight font-geist text-black mb-2">Choisissez votre méthode</h2>
