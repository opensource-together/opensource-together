...
export default function ProfileView() {
  ...
  return (
    <div className="mx-auto mt-4 flex max-w-[1300px] flex-col gap-5 px-4 sm:px-6 md:mt-8 md:px-8 lg:px-24 xl:px-40 items-center justify-center">
      ...
      <div className="mt-0 mb-30 w-full lg:pl-0 flex flex-col items-center justify-center">
