    ...
    <div className="flex flex-1 flex-col gap-5">
      {shouldShowStats && (
        <div className="mb-2 flex flex-col">
          <h2 className="text-primary mb-1 text-sm">Statistiques GitHub</h2>
      ...
      <div className="mb-2 flex flex-col">
        <h2 className="text-primary mb-2 text-sm">Technologies</h2>
        {techStacks.length > 0 ? (
      ...
      <div className="mb-2 flex flex-col">
        <h2 className="text-primary mb-4 text-sm">Liens externes</h2>
